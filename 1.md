...
A serious buffer overflow vulnerability was found on the UTT router Aggressive  HiPER 1200GW router, where an attacker could trigger the vulnerability by routing /goform/formTaskEdit, causing buffer overflow attacks and denial of service attacks, etc., specifically through "strcpy(InstPointByIndex + 20, src);" to be realized

# Vulnerability details

The API for invoking the function

![image-20260512110224031](1/image-20260512110224031.png)

You can see that these values are valued here

![image-20260512110352327](1/image-20260512110352327.png)

When the selDateType is 01, it will enter the if judgment, and there is no boundary detection here, resulting in overflow

![image-20260512110435281](1/image-20260512110435281.png)
